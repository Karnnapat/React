...
class Monitor extends Component{
    ...
    constructor(props) {
        ...
        confirmOrder(){
            ...
            this.setState({totalPrice: 0, orders: [], confirm : true, msg: ' เลือกสินค้าก่อนนะครับ '});
        }
    }
        cancleOrder(){
                ...
                <div className="container-fluid">
                    ...
                    <div className="row">
                        ...
                        <div className="col-md-3">
                            <Calculator totalPrice={this.state.totalPrice} orders={this.state.orders} onDelOrder={this.delOrder} onConfirmOrder={this.confirmOrder}  onCancelOrder={this.cancleOrder}/>
                        </div>
                    </div>
                </div>
            )
